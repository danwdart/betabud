<?php
class Betabud_Iterator_Dao_Mongo_Cursor implements Betabud_Iterator_Interface
{
    private $_cursor;
    ...
    public function __construct(Mongo_Cursor $cursor, Betabud_Dao_Mongo_Abstract $daoInterface)
    {
        $this->_cursor      = $cursor;
    ...
    public function current()
    {
        ...
        if (is_null($arrCurrentItem)) {
            throw new Betabud_Iterator_Exception_NonexistentModel(get_class($this->_daoInterface));
        }
    ...
    {
        throw new Betabud_Exception_NotImplemented();
    } 
